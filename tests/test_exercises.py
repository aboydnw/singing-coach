...
def test_spec_has_required_keys():
    ...
    required = {"type", "target_notes_midi", "duration_per_note_s", "vowel", "display_name"}
...
def test_display_name_includes_type_and_starting_note_name():
    ...
    # Starting note name should appear (e.g. "G3", "A4")
...
def test_walks_starting_note_across_tessitura():
    ...
    # Should walk across multiple starting positions, not stay on one
    assert len(starts) > 1
